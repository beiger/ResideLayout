...
public class ResideLayout extends ViewGroup {
	...
	protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
		...
		if (mCanSlide && !lp.slideable && mSlideableView != null) {
			canvas.scale(1.5f - 0.5f * mSlideOffset, 1.5f - 0.5f * mSlideOffset, child.getRight(), getHeight() / 2f);
		} else {
			canvas.scale(1 - mSlideOffset / 5, 1 - mSlideOffset / 5, mSlideableView.getLeft(), getHeight() / 2f);
